            ...
            try {
                ...
                if (res.data?.data) {
                    ...
                    const defaults = {
                        ...
                        manufacturer_name: comp.manufacturer_name || comp.name || '',
                        manufacturer_address: comp.manufacturer_address || comp.address || '',
            ...
            try {
                ...
                if (foundData && (foundData.backsideNo || foundData.backside_no)) {
                    ...
                    setFormData(prev => ({
                        ...
                        manufacturer_name: foundData.manufacturer_name || foundData.manufacturerName || mappedData.manufacturer_name || prev.manufacturer_name || companyDefaults?.name || '',
                        manufacturer_address: foundData.manufacturer_address || foundData.manufacturerAddress || mappedData.manufacturer_address || prev.manufacturer_address || companyDefaults?.address || '',
            ...
            if (mappedData) {
                ...
                setFormData(prev => {
                    ...
                    const newData = {
                        ...
                        manufacturer_name: mappedData.manufacturer_name || rawData?.manufacturer_name || rawData?.manufacturerName || prev.manufacturer_name || companyDefaults?.name || '',
                        manufacturer_address: mappedData.manufacturer_address || rawData?.manufacturer_address || rawData?.manufacturerAddress || prev.manufacturer_address || companyDefaults?.address || '',
