...
const AppRouter = ({ 
  ...
  const hasPermissionForView = (view) => {
    ...
    const viewPermissions = {
      ...
      'invoice-management': ['all', 'company_all', 'export_management'],
      'account-finance-management': ['all', 'company_all', 'account_finance'],
      'salesperson-management': ['all', 'company_all', 'salesperson_management'],
      'packing-list-management': ['all', 'company_all', 'export_management'],
      'export-management': ['all', 'company_all', 'export_management'],
      'export-shipping-instructions': ['all', 'company_all', 'export_management'],
      'shipping-instructions-form': ['all', 'company_all', 'export_management'],
      'export-invoice': ['all', 'company_all', 'export_management'],
      'export-invoice-form': ['all', 'company_all', 'export_management'],
      'export-invoice-annexure': ['all', 'company_all', 'export_management'],
      'export-invoice-annexure-form': ['all', 'company_all', 'export_management'],
      'invoice-backside': ['all', 'company_all', 'export_management'],
      'invoice-backside-dashboard': ['all', 'company_all', 'export_management'],
      'invoice-backside-form': ['all', 'company_all', 'export_management'],
      'vgm': ['all', 'company_all', 'export_management'],
      'vgm-form': ['all', 'company_all', 'export_management'],
      'igst-invoice': ['all', 'company_all', 'export_management'],
      'igst-invoice-form': ['all', 'company_all', 'export_management'],
      'packing-list-form': ['all', 'company_all', 'export_management'],
      'erp-flowchart': [],
      'support': [],
      'profile': [],
      'profile-settings': [],
