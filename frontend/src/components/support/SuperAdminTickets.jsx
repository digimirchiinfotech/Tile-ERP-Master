                ...
                <Button 
                  ...
                  onClick={async () => {
                    try {
                      ...
                      const response = await fetch(`${(import.meta.env.DEV || import.meta.env.MODE === 'development' ? '/api' : 'https://tile-erp-master-production.up.railway.app/api')}/export/support-tickets`, {
                        headers
                      });
