              ...
              <tbody>
                {formData.container_details.map((c, i) => (
                  <tr key={i} style={c.is_foc ? { backgroundColor: '#fff5f5' } : {}}>
                    ...
                    <td data-label="Pallets"><Form.Control size="sm" style={{ minWidth: '140px', maxWidth: '200px' }} value={c.pallet_detail || ''} onChange={e => handleContainerChange(i, 'pallet_detail', e.target.value.toUpperCase())} className="border-0 bg-light text-end text-lg-center ms-auto mx-lg-auto" placeholder="1-19" /></td>
