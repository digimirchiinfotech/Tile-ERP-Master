...
async function run() {
  try {
    const res = await pool.query(`INSERT INTO clients 
       ...
       RETURNING *`, [
      '66e68258-a6fc-4ad2-b014-22e086e1cff2', 'CLI-001', 'Test Name', 'Person', 'a@a.com', '123', 'addr', 'city', 'country', 'bt', 0, 0, null, 'Active', 'notes', 'consignee', 'buyer', 'MUNDRA PORT', 'pod', 'fd', 'INR', '66e68258-a6fc-4ad2-b014-22e086e1cff2'
    ]);
